...
import Constants, { contractAddress } from '../config';
import BigNumber from "bignumber.js";
import { constants } from 'buffer';

const Web3 = require('web3');
// const worldOfcthulhuJsonFile = require("../contracts/WorldOfcthulhu.json");
const createPartyJsonFile = require("../contracts/CreateParty.json");
const wzenyJsonFile = require("../contracts/Wzeny.json");
// const workdOfcthulhuABI = worldOfcthulhuJsonFile["abi"];
...
//             let contract = await new web3.eth.Contract(workdOfcthulhuABI, Constants.ContractAddress)
//             if (walletAddress) {
...
//     let contract = new Contract(workdOfcthulhuABI, Constants.ContractAddress)
//     try {
